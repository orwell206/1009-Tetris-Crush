...
public:
	...
	void render_game(const GameBoard*, SDL_Renderer*);
	...
	void update_game(GameBoard*, const InputState*);
...
void GameBoard::render_game(const GameBoard *gameboard, SDL_Renderer *renderer){
...
void GameBoard::update_game(GameBoard *gameboard, const InputState *input){
